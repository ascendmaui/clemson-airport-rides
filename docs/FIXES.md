...
- **Not applied:** Do not run this file until John approves. Version prefix `20260925120000` is already used by `supabase/migrations/20260925120000_ambassador_payout_unique.sql`. Rename this file to a free version before `supabase db push` if the CLI rejects the duplicate.
