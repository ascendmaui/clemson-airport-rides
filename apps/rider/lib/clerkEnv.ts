...
export function missingClerkPublishableMessage() {
  return 'Apple, Google, and Facebook sign-in need EXPO_PUBLIC_CLERK_PUBLISHABLE_KEY on the rider EAS project. Email and password still work. The env checklist is in apps/rider/README.md.'
}
